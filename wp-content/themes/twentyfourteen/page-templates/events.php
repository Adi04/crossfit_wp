...
<center><img src="<?php bloginfo('template_url'); ?>/images/w6.jpg"></center>
    ...
    <div class="container">
        ...
        <div class="left">
         	<div class="grey" style="margin:00">
            	<img src="<?php bloginfo('template_url'); ?>/images/x7.jpg" style="float:left; margin-right:15px; margin-bottom:00px">
